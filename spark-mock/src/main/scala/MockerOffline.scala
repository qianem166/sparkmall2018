...
import com.atguigu.sparkmall2018.mock.util.RandomNum._
import com.atguigu.sparkmall2018.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
            ...
            while (!isQuit) {
                ...
                if (action == "quit") {
                    ...
                    action match {
                        ...
                        case "order" => orderCategoryIds = multi(1, cargoryNum, RandomNum(1, 5), ",", false)
                            orderProductIds = multi(1, cargoryNum, RandomNum(1, 5), ",", false)
                        case "pay" => payCategoryIds = multi(1, cargoryNum, RandomNum(1, 5), ",", false)
                            payProductIds = multi(1, cargoryNum, RandomNum(1, 5), ",", false)
                    }
